...
class ImageDataset(torch.utils.data.Dataset):
    '''
    this class is for loading image dataset using torch.utils.data.DataLoader
    '''
    def __init__(self, 
                 istrain: bool,
                 root: str,
        ...
        format: [{"path":data_path, "label":class_id}, ...]
        """
    ...
    def __getitem__(self, index):
        '''
        implement this function for torch.utils.data.DataLoader
        '''
